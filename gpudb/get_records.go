...
func (gpudb *Gpudb) GetRecordsRaw(
	ctx context.Context,
...
func (gpudb *Gpudb) GetRecordsRawWithOpts(
	ctx context.Context,
...
func (gpudb *Gpudb) buildGetRecordsOptionsMap(ctx context.Context, options *GetRecordsOptions) *map[string]string {
	var (
		childSpan trace.Span
	)
...
func (gpudb *Gpudb) GetRecordsMap(
	ctx context.Context,
...
func (gpudb *Gpudb) GetRecordsMapWithOpts(
	ctx context.Context,
...
func (gpudb *Gpudb) GetRecordsStruct(
	ctx context.Context,
...
func (gpudb *Gpudb) GetRecordsStructWithOpts(
	ctx context.Context,
...
func GetRecordsStructWithOpts[T any](
	ctx context.Context,
	gpudb Gpudb, table string, offset int64, limit int64, options *GetRecordsOptions) ([]T, error) {
	var (
		childCtx   context.Context
		childSpan  trace.Span
		resultList []T
	...
	if options.Encoding == "binary" {
		resultList = make([]T, len(raw.RecordsBinary))
		for i, value := range raw.RecordsBinary {
			avro.Unmarshal(recordSchema, value, &resultList[i])
		}
...
func (gpudb *Gpudb) GetRecordsStructSendChannel(
	ctx context.Context,
...
func (gpudb *Gpudb) GetRecordsStructSendChannelWithOpts(
